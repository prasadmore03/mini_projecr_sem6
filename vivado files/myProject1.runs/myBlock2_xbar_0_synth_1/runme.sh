...
HD_PWD='C:/Users/hp/Desktop/NeuralNetwork2/Tut-8/myProject1/myProject1.runs/myBlock2_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myBlock2_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myBlock2_xbar_0.tcl
